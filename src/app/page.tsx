...
export default function HomePage() {
  return (
    <main className="flex-1 flex flex-col gap-6 min-h-full max-w-3xl mx-auto py-20">
      ...
      <a href="https://open.spotify.com/intl-pt/track/43WN6G6fDiat8RPDyTFOT7" target="_blank" className="flex items-center justify-center self-center gap-2 min-h-8 rounded-full border border-border w-fit px-3">
      ...
      <nav className="flex flex-col gap-2 w-full max-w-xl mx-auto">
        <a href="https://www.youtube.com/watch?v=f7t4GUuzAHQ" className="flex items-center justify-center rounded-md min-h-12 text-center hover:bg-gray-100">
          Veja o lyric vídeo de {'"'}Melhor do Que Antes{'"'} no YouTube
        </a>
        <a href="https://instagram.com/likeatear_" target="_blank" className="flex items-center justify-center rounded-md min-h-12 text-center hover:bg-gray-100">
          Siga gente no Insta
        </a>
        <a href="https://likeatear.com" target="_blank" className="flex items-center justify-center rounded-md min-h-12 text-center hover:bg-gray-100">
          Conheça nosso site
        </a>
      </nav>
    </main>
